...
export const site = {
  ...
  shortDescription:
    "Hope House is a church-founded children's home and school. We provide a loving family, daily meals, and a complete education to children who need it most.",
  founded: 2009,
  childrenServed: 84,
  graduates: 217,
  contact: {
    ...
    address: "Hope House, Riverside Lane, Nairobi, Kenya",
  },
  social: {
...
export const stories = [
  {
    ...
    age: 14,
    quote:
      "When I came to Hope House I didn't know how to read. Now I'm top of my class in science and I want to be a nurse.",
  },
  {
    name: "Joseph",
    age: 11,
